...
let notificationMarkAllReadBtn = document.getElementById('notificationMarkAllReadBtn') ??
    document.getElementById('markNotificationsReadBtn');
// ======================================================
// NOTIFICATION STATE
// ======================================================
...
async function loadNotifications() {
    ...
    try {
         ...
         */
        console.warn('Notifications unavailable:', error instanceof Error ? error.message : String(error));
    }
    finally {
        notificationsLoading =
            false;
