...
interface ProfileAvatarUpdateEventDetail {
    avatarUrl?: string;
}
...
function loadProfileState(): boolean {
...
async function refreshProfileFromServer(): Promise<boolean> {
...
function setupProfileUpdateListener(): void {
    ...
    window.addEventListener(
        ...
        (event: Event) => {
            ...
            const customEvent =
                event as CustomEvent<ProfileUpdateEventDetail>;
...
function setupAvatarUpdateListener(): void {
    ...
    window.addEventListener(
        ...
        (event: Event) => {
            ...
            const customEvent =
                event as CustomEvent<ProfileAvatarUpdateEventDetail>;
